                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <strong tkey="MODAL__SOLICITUD_PETICIONES__MODAL_2_ASISTENTES__info__codigo">Codi petició:</strong>  <span  style="font-weight:bolder;" id="codigoPeticionResumen"></span> <br>
                        ...
                        <div class="modal-footer">
                            <button onclick="procesarRealizarPeticion()" class="btn btn-primary" id="botonEnviarAsignarPeticion" tkey="MODAL__SOLICITUD_PETICIONES__MODAL_3_ASISTENTES__boton__enviar">Enviar</button>
