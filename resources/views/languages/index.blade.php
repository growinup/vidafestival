        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">LLISTAT DE IDIOMES</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <div class="row mb-3">
                    <div class="col-4">
                        <h4>LLISTAT DE IDIOMES</h4>
                    </div>
                </div>

                <div class="row">
                    <div class="col">
                            <button class="btn btn-primary" onclick="newLanguage()">Nou idioma</button>
                    </div>
                </div>
                <hr>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <table id="languagesTable" class="table table-striped table-bordered nowrap" style="width:100%">
                            <thead></thead>
                            <tbody></tbody>
                        </table>                        
                    </div>
